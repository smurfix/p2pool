...
from p2pool import p2p, networks, web
...
def run():
    ...
    datadir_path = os.path.join((os.path.join(os.environ["HOME"] or os.path.dirname(sys.argv[0]), 'data') if args.datadir is None else args.datadir), net_name)
